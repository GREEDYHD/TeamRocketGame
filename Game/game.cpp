...
Game::Game(ID3D11Device* _pd3dDevice, HINSTANCE _hInstance) :m_playTime(0), m_myEF(nullptr)
{
	...
	m_cam->SetPos(Vector3(0.0f, 1.0f,0.0f));
	m_GameObjects.push_back(m_cam);

	m_GameObject2Ds.push_back(new MapLoader("128x128", _pd3dDevice));

	m_GameObject2Ds.push_back(new Player("testSprite", _pd3dDevice));
	...
	m_GameObjects.push_back(terrain);
		...
		m_TPSCam = new TPSCamera(0.25f * XM_PI, 640.0f / 480.0f, 1.0f, 10000.0f, logo, Vector3::UnitY, Vector3(-200.0f, 100.0f, 0.0f));
